$(document).ready(function () {
    Date.prototype.calcDate = function (days) {
        ...
        return `(Until ${date.getUTCDate()}-${date.getUTCMonth() +
	...
	function savePrescriptionAsPDF() {
        const element = document.querySelector(".prescription_form");
        html2pdf(element, {
            margin: 10,
            ...
            pagebreak: { avoid: ".table-bordered" }
        });
    }
